...
im = Image.open(r"C:\Users\vincentc.PHY\Desktop\kurt\p2\body_100px_15_colours.png").convert('RGB') #Can be many different formats.
...
dataframe.to_csv(r"C:\Users\vincentc.PHY\Desktop\kurt\p2\body_100px_15_colours.csv", index=False, header=False, sep=';')
from PIL import Image
